...
book1 = new Book ("1","Anna Karena","A beautiful wife from St..","../img/img1.jpg","$19.99","Leo Tolstoy")
booksData.push(book1)
book2 = new Book ("2","Sand and Foam","A book of aphorisms, poems, and parables by the author ","../img/book2.jpg","20$","Gobran Khalel Gobran")
booksData.push(book2)
book3 = new Book ("3","Vineland","The story is set in California, usa","../img/book33.jpg","50$",	"Thomas Pynchon")
booksData.push(book3)
book4 = new Book ("4","	Americana","Ifemelu and Obinze are young and in love ","../img/book4.jpg","22$","Chimamanda Ngozi Adichie")
booksData.push(book4)
book5 = new Book ("5","Great Jones Street"," It centers on rock star Bucky Wunderlick,","../img/book5.jpg","23$","Don DeLillo")
booksData.push(book5)
book6 = new Book ("6","Mason & Dixon"," It presents a fictionalized account of the collaboration ","../img/book6.jpg","25$","Thomas Pynchon")
booksData.push(book6)
book7 = new Book ("7","Against the Day"," It presents a fictionalized account of the collaboration","../img/book7.jpg","30$","Thomas Pynchon")
booksData.push(book7)
book8 = new Book ("8","Gravity's Rainbow","Lengthy, complex, and featuring a large cast of characters","../img/book8.jpg","10$","Thomas Pynchon")
